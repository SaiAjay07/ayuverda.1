      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <a href="/know-your-prakriti" className="text-green-800 hover:text-green-600 transition-colors">Know Your Prakriti</a>
        ...
        {isOpen && (
          <div className="md:hidden mt-4 pb-4">
            <div className="flex flex-col space-y-4">
              <a href="/" className="text-green-800 hover:text-green-600 transition-colors" onClick={() => setIsOpen(false)}>Home</a>
              ...
              <a href="/know-your-prakriti" className="text-green-800 hover:text-green-600 transition-colors" onClick={() => setIsOpen(false)}>Know Your Prakriti</a>
